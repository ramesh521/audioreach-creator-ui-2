...
} from '~shared/controls/arc-channel-config-dialog';
...
jest.mock('~shared/controls/arc-text-input', () => {
  return jest
    .fn()
...
describe('ArcChannelConfigDialog', () => {
  ...
  describe('Channel Count Management', () => {
    ...
    it('should initialize with selectedChannelValues count when provided', () => {
      ...
      const channelCountInput = screen.getByTestId('arc-text-input');
      expect(channelCountInput).toHaveValue(2); // Max key is 2 (0-indexed keys: 0, 1, 2)
    });
  ...
  describe('Component Lifecycle', () => {
    ...
    it('should handle prop changes gracefully', () => {
      ...
      rerender(
        <ArcChannelConfigDialog {...defaultProps} maxChannelCount={5} />,
      );
