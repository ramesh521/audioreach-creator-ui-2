...
git rebase origin/feature/open-file  # Sync with feature branch
git st                             # Check status
...
git co feature/open-file
git rebase origin/main
git pushf origin feature/open-file
...
```bash
git st                                    # Status
git diff origin/feature/open-file     # Changes vs feature branch
git log --oneline origin/feature/open-file.. # Commits not in feature branch
```
...
- [ ] `git fetch origin && git rebase origin/feature/open-file` - Synced with feature branch
